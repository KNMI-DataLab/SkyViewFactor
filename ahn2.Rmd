...
AHN2_tile_all<-list.files(path=paste0(AHN2clean_lazdir,tile),pattern="*_2.laz",full.names = TRUE)
AHN2_tile_all_short<-list.files(path=paste0(AHN2clean_lazdir,tile),pattern="*_2.laz")
...
Sys.setenv("AHN"=AHN2_tile_all[i]) # set variable also for bash
Sys.setenv("AHNname"=AHN2_tile_all_short[i]) # set variable also for bash
